...
const BookingForm = () => {
   ...
   return (
      <div className="mt-[210px] mb-10  border-t-4 mx-12 shadow-2xl p-5">
         <div>
            <h1 className=" text-left justify-center mt-7 text-black font-bold text-xl">
               Book a bike
            </h1>
         </div>
         <br />
         <div className="grid grid-cols-3 grid-rows-1 space-x-6">
            <div>
               {" "}
               <label
                  htmlFor="bike"
         ...
         <div className="grid grid-cols-3 grid-rows-1 space-x-6">
            <div className="mb-4">
               ...
               {showCalendar1 && (
                  <div className="absolute mt-2 bg-white border border-gray-300 shadow-lg ">
                     <DatePicker
                        selected={pickupdate}
                        onChange={(date) => {
                           setPickupdate(date);
            ...
            <div className="mb-4">
               <label
                  ...
                  className="block  text-left text-black font-semibold mb-2"
               >
                  Drop-of<span className="text-red-600">*</span>
               </label>
               <div className="relative">
                  <input
                     type="text"
               ...
               {showCalendar2 && (
                  <div className="absolute mt-2 bg-white border border-gray-300 shadow-lg ">
                     <DatePicker
                        ...
                        onChange={(date) => {
                           setDropoffdate(date);
                           setShowCalendar2(false); // Hide the calendar after selecting a date
                        }}
                        inline
                     />
                  </div>
