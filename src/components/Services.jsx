    ...
    <div className="flex flex-col mx-4 md:mx-12 mt-12 md:mt-24 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 md:mt-12">
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6 text-black">Select Bike</h1>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6 text-black">Contact Operator</h1>
          <p className=" text-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6 text-black">Let's Drive</h1>
          <p className=" text-center">
