...
const Services = () => {
  return (
    <div className="flex flex-col mx-4 md:mx-12 mt-12 md:mt-24">
      <div>
        <h6 className="text-2xl md:text-4xl font-medium">Plan your trip now</h6>
        <h1 className="text-4xl md:text-6xl font-semibold">Quick & easy bike rental</h1>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 md:mt-12">
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6">Select Bike</h1>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6">Contact Operator</h1>
          <p className="text-gray-500 text-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <h1 className="text-xl md:text-2xl font-bold p-6">Let's Drive</h1>
          <p className="text-gray-500 text-center">
